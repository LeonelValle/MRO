...
namespace MROInventory_Project
{
    class Conexion
    {
        ...
        public Conexion() =>
            ...
            Con1 = new SqlConnection(@"Data Source=MEX-SQL-001;Initial Catalog=MROInventorydb;User ID=admin_sql;Password=DaBatase#40107;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
